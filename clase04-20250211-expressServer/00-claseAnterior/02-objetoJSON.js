...
fs.writeFileSync(
    ...
    JSON.stringify(heroes, null, 5)
)

let datoRecuperado=JSON.parse(fs.readFileSync(rutaArchivo, "utf-8"))
console.log(datoRecuperado, typeof datoRecuperado)
console.log(datoRecuperado[0].name)
